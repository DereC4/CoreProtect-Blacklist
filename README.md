...
minecraft:trader_llama@#drowned
minecraft:wandering_trader@#drowned
minecraft:drowned@#llama_spit
minecraft:trader_llama@#zombie
minecraft:zombie@#llama_spit
minecraft:trader_llama@#llama_spit
